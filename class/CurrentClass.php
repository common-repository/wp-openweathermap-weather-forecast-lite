...
/*
// Place your openweathermap API key. get this API from openweathermap.org
$owapi = "aaddbefba9597425177be89dafe8c563"; // Get it from openweathermap.org
// Place your Bing Map API
$bingapi = "AkIKyiomsfKf-PJpajdHADHpU-qxZKTDis8_l233Puzf8mZr4_MPf4VgSTGB9IGC";
// Get API from ipinfodb.com
$ipinfoapi = "d19bc459913bc164f91849a6bbe0814c912168dc704a4a0f0b92ed4bea9e4265"; // get it from ipinfodb.com
...
class CurrentClass
{
  ...
  public function __construct($api, $city, $unit)
  {
     ...
     $getJson = @wp_remote_retrieve_body(wp_remote_get($owUrl));
  ...
  // get lattitude
   ...
   public function pressure() {
      ...
      return round($this->getArr['main']['pressure'],1);
      }
   }
   ...
   public function dt() {
    ...
    $formattedDT = gmdate("D | F d, H:i:s", $timestamp);
    return $formattedDT;
   }
   ...
   // sunrise local time
   public function sunriseLocal() {
      if (array_key_exists('sunrise', $this->getArr['sys'])) {
      $timestamp = $this->getArr['sys']['sunrise'];
        //$formattedDT = gmdate("Y-m-d\TH:i:s\Z", $timestamp);
        $formattedDT = gmdate("F d, H:i:s", $timestamp);
        return $formattedDT;
     }
   }
   ...
   //sun set local time
   public function sunsetLocal() {
    if (array_key_exists('sunset', $this->getArr['sys'])) {
       $timestamp = $this->getArr['sys']['sunset'];
       // $formattedDT = gmdate("Y-m-d\TH:i:s\Z", $timestamp);
       $formattedDT = gmdate("F d, H:i:s", $timestamp);
       return $formattedDT;
    }
...
//$currentObj = new CurrentClass("aaddbefba9597425177be89dafe8c563", "london", "metric");
//echo $currentObj->temp();
//echo "<br/><br/><pre>";
//print_r($currentObj->getArr);
