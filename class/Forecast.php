...
class Forecast
{
  ...
  public function __construct($api, $city, $fcUnit)
  {
     ...
     $filecontents = @wp_remote_retrieve_body(wp_remote_get($owUrl));
 ...
 /* public function fcArr {
  ...
  public function fcPressure($num) {
    return round($this->fcArr["list"][$num]["pressure"],1);
  }
...
// $currentObj = new Forecast();
/*$fcObj = new Forecast("aaddbefba9597425177be89dafe8c563", "london", "imperial");
echo $fcObj->fcRain(6);
