...
jQuery( document ).ready( function( $ ) {
	$( '.max-temp-chart-bg' ).wpColorPicker();
	$( '.max-temp-chart-border' ).wpColorPicker();
	$( '.min-temp-chart-bg' ).wpColorPicker();
	$( '.min-temp-chart-border' ).wpColorPicker();

	$( '.humidity-chart-bg' ).wpColorPicker();
	$( '.humidity-chart-border' ).wpColorPicker();

	$( '.pressure-chart-bg' ).wpColorPicker();
	$( '.pressure-chart-border' ).wpColorPicker();
	$( '.fc_icon_color' ).wpColorPicker();
} );